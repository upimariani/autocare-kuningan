				...
				<div class="sidebar-content">
					<div class="nav-container">
						<nav id="main-menu-navigation" class="navigation-main">
							...
							<div class="nav-item <?php if ($this->uri->segment(1) == 'ServiceAdvisor' && $this->uri->segment(2) == 'cTransaksi') {
														echo 'active';
													}  ?>">
								<a href="<?= base_url('ServiceAdvisor/cTransaksi') ?>"><i class="ik ik-shopping-cart"></i><span>Transaksi</span> <span class="badge badge-warning"></span> </a>
							</div>
							<div class="nav-item">
